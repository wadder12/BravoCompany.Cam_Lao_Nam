...
ace_interact_menu_more__KPR_Admin = false;
...
ace_interact_menu_moveToRoot__ACE_Equipment__ClearBrush = false;
...
ace_interact_menu_moveToRoot__ACE_Equipment__KPR_Check = false;
...
ace_interact_menu_moveToRoot__KPR_Admin__KPR_PlayerManage = false;
ace_interact_menu_moveToRoot__KPR_Admin__KPR_UniformManage = false;
...
ace_medical_blood_maxBloodObjects = 250;
force ace_medical_deathChance = 0.3;
...
ace_medical_treatment_maxLitterObjects = 250;
...
force ace_nightvision_noiseScaling = 0.470615;
...
// ACE Pharmacy - AED
force aceP_circulation_CPR_Chance_Default = 20;
force aceP_circulation_CPR_Chance_Doctor = 40;
force aceP_circulation_CPR_Chance_RegularMedic = 30;
force aceP_circulation_DeactMon_whileAED_X = true;
force aceP_circulation_distanceLimit_AEDX = 30;
force aceP_circulation_enable_CPR_Chances = true;
force aceP_circulation_medLvl_AED_X = 2;
force aceP_circulation_SuccesCh_AED = 80;
force aceP_circulation_SuccesCh_AED_X = 85;
force aceP_circulation_timeLimit_AEDX = 1800;
force aceP_circulation_useLocation_AED = 0;

// ACE Pharmacy - Fractures
force aceP_circulation_closedLocation = 0;
...
force aceP_circulation_surgicalAction = 2;
...
force aceP_circulation_blockChance = 20;
force aceP_circulation_coagulation = true;
force aceP_circulation_factorDrugs = 2;
force aceP_circulation_IOestablish = 7;
force aceP_circulation_IVdrop = 600;
force aceP_circulation_IVdropEnable = true;
force aceP_circulation_IVestablish = 7;
force aceP_circulation_IVmedic = 1;
force aceP_circulation_IVreuse = false;
force aceP_circulation_kidneyAction = false;
force aceP_circulation_maxStack = 5;
force aceP_circulation_PushTime = 7;
...
// Brush Clearing
ClearBrush_requireEntrenchingTool = true;
...
// DCO soldier FSM V. 0.43
force PR_Allow_HC = true;
force PR_HC1 = "HC1";
force PR_Use_HC = true;
...
force SFSM_CQBunitCap = 2;
force SFSM_Debugger = false;
force SFSM_disableSoldierFSM = false;
...
// DCO ToolBox 0.11
force DCOT_ambientLife = true;
forceDCOT_craters = true;
force DCOT_debug = false;
force DCOT_Hc3dIcons = false;
force DCOT_HcMapIcons = false;

// DCO Vehicle FSM
force DCOCourageMultiplier = false;
force DCOexcludePlayerGroups = false;
force DCOnoFlankGlobal = false;
force DCOnoGroupReset = false;
force DCOnoHideGlobal = false;
force DCOnoPushGlobal = false;
force DCOnoSmoke = false;
force DCOquickReaction = 0;
force FSMD3Bugger = false;
force globalAgressionMultiplier = 1.7;
force iterationTimer = 1;
force VehicleAutoRepair = true;
force VehMinimumDistance = 250;

// DCO Vehicle Unstuck
force DCOUS_debug = false;
force DCOUS_disable = false;
force DCOUS_maxPosStorage = 100;
force DCOUS_minDataSample = 20;
force DCOUS_playerNearNoTeleport = 300;
force DCOUS_teleportBlockType = 0;
force DCOUS_teleportDist = 50;
force DCOUS_updateFrequency = 3;
...
force DYNCAS_ghillieReduction = 0.3;
force DYNCAS_lowerLimit = 0.35;
...
force emr_main_maxClimbHeight = 3.0;
force emr_main_maxDropHeight = 6.0;
...
force emr_main_minClimbTerrain = .3;
...
sp_fwa_pipstretchfactor = 0;
sp_fwa_preferedOptic = 0;
sp_fwa_preferedOpticHighMag = 0;
...
zen_faction_filter_0_O_NVA_KHK = true;
zen_faction_filter_0_O_NVA_WDL = true;
zen_faction_filter_0_O_VC_BLK = true;
zen_faction_filter_0_O_Viet_Cong = true;
...
zen_faction_filter_1_B_6RAR_OD = true;
zen_faction_filter_1_B_ARVN_TS = true;
zen_faction_filter_1_B_SS_USM_1965 = true;
zen_faction_filter_1_B_USA_1965 = true;
zen_faction_filter_1_B_USA_1SFG = true;
zen_faction_filter_1_B_USA_LRRP_TS = true;
zen_faction_filter_1_B_USA_SOG = true;
zen_faction_filter_1_B_USA_SOG_OD = true;
zen_faction_filter_1_B_USN_ST2 = true;
...
force zen_faction_filter_1_CUP_B_GB = true;
force zen_faction_filter_1_CUP_B_GER = true;
force zen_faction_filter_1_CUP_B_US_Army = true;
force zen_faction_filter_1_CUP_B_USMC = true;
...
zen_faction_filter_1_PVN_USA_1968 = true;
zen_faction_filter_1_PVN_USA_7AC = true;
zen_faction_filter_1_PVN_USM_1967 = true;
zen_faction_filter_1_PVN_USM_1968 = true;
...
zen_faction_filter_1_Simc_UA_65 = true;
zen_faction_filter_1_Simc_UA_67 = true;
...
zen_faction_filter_3_C_Vietnam = true;
