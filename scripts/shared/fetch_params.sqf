...
if(isServer) then {
    ...
    GET_PARAM(GRLIB_difficulty_modifier, "Difficulty", 7);
    GET_PARAM(GRLIB_csat_aggressivity, "Aggressivity", 4);
    GET_PARAM_BOOL(GRLIB_adaptive_opfor, "AdaptToPlayercount", 1);
    GET_PARAM(GRLIB_civilian_activity, "Civilians", 0);
    ...
    GET_PARAM(GRLIB_time_factor, "DayDuration", 6);
    ...
    GET_PARAM(KP_liberation_victoryCondition, "VictoryCondition", 4);
    ...
    GET_PARAM_BOOL(GRLIB_fatigue, "Fatigue", 0);
    GET_PARAM_BOOL(KPLIB_sway, "WeaponSway", 0);
    ...
    GET_PARAM_BOOL(KP_liberation_commander_zeus, "CommanderZeus", 0);
    GET_PARAM_BOOL(KP_liberation_enemies_zeus, "ZeusAddEnemies", 1);
    GET_PARAM_BOOL(KP_liberation_high_command, "HighCommand", 0);
    ...
    GET_PARAM(KP_liberation_restart, "ServerRestart", 6);
